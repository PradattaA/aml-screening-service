...
public class NameConstant {
    ...
    public static List<String> NOISE_WORD = Arrays.asList("to", "the", "and", "van", "king", "sir", "general",
                                                          "president", "lieutenant", "private", "limited", "gmbh",
                                                          "pvt.", "pvt", "ltd.", "ltd", "inc", "corp", "corp.", "corporation");
